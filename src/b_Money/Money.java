...
public class Money implements Comparable {
	...
	public Boolean equals(Money other) {
		if(other.getCurrency() == currency){
			if(other.getAmount() == amount)
				return true;
			return false;
		}
		if(other.universalValue().equals(this.universalValue()))
			return true;
		return false;
	}
	...
	public int compareTo(Object other) {
		...
		return currency.universalValue(amount) - otherMoney.getCurrency().universalValue(otherMoney.getAmount());
	}
}